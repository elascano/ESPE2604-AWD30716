...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
    $keyboardToDelete = keyboards::find($_POST['id']);
    if ($keyboardToDelete) {
        $keyboardToDelete->delete();
    }
    ...
    <header class="container mt-3">
        <nav>
            <ul class="nav nav-pills nav-fill mb-4">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Delete keyboard</a>
                </li>
            </ul>
        </nav>
        <h1>Delete keyboard Record</h1>
    </header>
    ...
    <main class="container">
        <div class="delete-container shadow-sm border-danger">
            ...
            <div class="record-details p-3 mb-4 bg-light rounded">
                <p><strong>keyboard ID:</strong> <?= $keyboard->id ?></p>
            </div>
