...
if (isset($_GET['id'])) {
    $keyboard = keyboards::find($_GET['id']);
}
?>
    ...
    <header class="container mt-3">
        <nav>
            <ul class="nav nav-pills nav-fill mb-4">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Update keyboard</a>
                </li>
            </ul>
        </nav>
        <h1>Update Existing keyboard</h1>
    </header>
