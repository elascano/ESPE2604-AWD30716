...
export class FetchController {
    ...
    // 1. GET GENÉRICO (Sirve para 'todos' o con 'filtros')
    ...
    static async getData(endpoint, params = null) {
        try {
            ...
            // Si llegan parámetros (filtros), los agregamos a la URL
            if (params) {
    ...
    // 2. GET BY ID (El método que te faltaba conceptualmente)
    ...
    // 4. PUT (Reemplazar) - OJO: Se pide el ID explícitamente en la URL
    ...
    // 5. PATCH (Actualizar parcial) - OJO: También requiere ID en la URL
    ...
    // 6. DELETE (Borrar) - OJO: Requiere ID en la URL
