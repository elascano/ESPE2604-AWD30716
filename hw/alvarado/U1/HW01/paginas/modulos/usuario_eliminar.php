<?php
// Seguridad
if (!in_array('usuario_eliminar', $_SESSION['permisos'])) {
...
<form method="get" action="inicio.php" class="w3-center w3-margin-bottom">
    <input type="hidden" name="op" value="usuario_eliminar">
...
<a class="w3-button w3-light-grey" href="inicio.php?op=usuario_eliminar">Limpiar</a>
...
<tr>
	...
	<td>
	<?php if ($fila['Estado_user'] === 'Activo'): ?>
		<form action="../server/cambiar_estado_usuario.php"
			  method="post"
...
<?php else: ?>
<tr>
    <td colspan="7" class="w3-center">No hay registros</td>
</tr>
<?php endif; ?>
</table>
