...
<form method="get" action="inicio.php" class="w3-center w3-margin-bottom">
    <input type="hidden" name="op" value="permisos_editar_buscar">
    ...
    <a class="w3-button w3-light-grey" href="inicio.php?op=permisos_editar_buscar">
        Limpiar
    </a>
</form>
...
<tr>
	...
	<td>
		<form action="inicio.php?op=permisos_editar" method="post">
